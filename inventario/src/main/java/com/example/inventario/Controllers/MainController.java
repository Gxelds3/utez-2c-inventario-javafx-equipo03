...
import com.example.inventario.Model.Producto; // Asegúrate de que la ruta sea correcta
import com.example.inventario.ProductoService.ProductoService;
...
public class MainController {
    ...
    public void nuevo() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/inventario/views/form-view.fxml"));
    ...
    public void editar() throws IOException {
        if (itemSeleccionado != null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/inventario/views/editarProducto.fxml"));
            Parent root = loader.load();
